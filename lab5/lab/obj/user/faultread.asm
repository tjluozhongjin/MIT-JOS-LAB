	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ef:	0f be 80 88 1e 80 00 	movsbl 0x801e88(%eax),%eax
  8001f6:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002b1:	ff 24 85 c0 1f 80 00 	jmp    *0x801fc0(,%eax,4)
  ...
  800378:	8b 14 85 20 21 80 00 	mov    0x802120(,%eax,4),%edx
  80037f:	85 d2                	test   %edx,%edx
  800381:	75 1b                	jne    80039e <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800383:	50                   	push   %eax
  800384:	68 a0 1e 80 00       	push   $0x801ea0
  800389:	53                   	push   %ebx
  80038a:	56                   	push   %esi
  ...
  80039e:	52                   	push   %edx
  80039f:	68 51 22 80 00       	push   $0x802251
  8003a4:	53                   	push   %ebx
  8003a5:	56                   	push   %esi
  ...
  8003c9:	b8 99 1e 80 00       	mov    $0x801e99,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800af1:	68 7f 21 80 00       	push   $0x80217f
  800af6:	6a 23                	push   $0x23
  800af8:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b72:	68 7f 21 80 00       	push   $0x80217f
  800b77:	6a 23                	push   $0x23
  800b79:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bbb:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bf6:	68 7f 21 80 00       	push   $0x80217f
  800bfb:	6a 23                	push   $0x23
  800bfd:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c38:	68 7f 21 80 00       	push   $0x80217f
  800c3d:	6a 23                	push   $0x23
  800c3f:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800c7a:	68 7f 21 80 00       	push   $0x80217f
  800c7f:	6a 23                	push   $0x23
  800c81:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cbc:	68 7f 21 80 00       	push   $0x80217f
  800cc1:	6a 23                	push   $0x23
  800cc3:	68 9c 21 80 00       	push   $0x80219c
...
sys_ipc_recv(void *dstva)
{
  ...
  800d20:	68 7f 21 80 00       	push   $0x80217f
  800d25:	6a 23                	push   $0x23
  800d27:	68 9c 21 80 00       	push   $0x80219c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e0e:	ba 28 22 80 00       	mov    $0x802228,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e39:	51                   	push   %ecx
  800e3a:	50                   	push   %eax
  800e3b:	68 ac 21 80 00       	push   $0x8021ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801063:	53                   	push   %ebx
  801064:	50                   	push   %eax
  801065:	68 ed 21 80 00       	push   $0x8021ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801138:	53                   	push   %ebx
  801139:	50                   	push   %eax
  80113a:	68 09 22 80 00       	push   $0x802209
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011ed:	53                   	push   %ebx
  8011ee:	50                   	push   %eax
  8011ef:	68 cc 21 80 00       	push   $0x8021cc
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  801450:	68 38 22 80 00       	push   $0x802238
  801455:	68 3f 22 80 00       	push   $0x80223f
  80145a:	68 82 00 00 00       	push   $0x82
  80145f:	68 54 22 80 00       	push   $0x802254
  801464:	e8 c0 05 00 00       	call   801a29 <_panic>
	assert(r <= PGSIZE);
  801469:	3d 00 10 00 00       	cmp    $0x1000,%eax
  80146e:	7e 19                	jle    801489 <devfile_read+0x6b>
  801470:	68 5f 22 80 00       	push   $0x80225f
  801475:	68 3f 22 80 00       	push   $0x80223f
  80147a:	68 83 00 00 00       	push   $0x83
  80147f:	68 54 22 80 00       	push   $0x802254
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801562:	68 6b 22 80 00       	push   $0x80226b
  801567:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801612:	50                   	push   %eax
  801613:	56                   	push   %esi
  801614:	68 72 22 80 00       	push   $0x802272
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018b6:	68 8a 22 80 00       	push   $0x80228a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a45:	56                   	push   %esi
  801a46:	50                   	push   %eax
  801a47:	68 98 22 80 00       	push   $0x802298
  ...
  801a58:	e8 93 e6 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801a5d:	c7 04 24 7c 1e 80 00 	movl   $0x801e7c,(%esp)
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801ab4:	68 bc 22 80 00       	push   $0x8022bc
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b12:	74 12                	je     801b26 <ipc_send+0x35>
			panic("ipc_send: %e", r);
  801b14:	50                   	push   %eax
  801b15:	68 c4 22 80 00       	push   $0x8022c4
  801b1a:	6a 4e                	push   $0x4e
  801b1c:	68 d1 22 80 00       	push   $0x8022d1
