...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 6a 1e 80 00       	push   $0x801e6a
  800114:	6a 23                	push   $0x23
  800116:	68 87 1e 80 00       	push   $0x801e87
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 6a 1e 80 00       	push   $0x801e6a
  800195:	6a 23                	push   $0x23
  800197:	68 87 1e 80 00       	push   $0x801e87
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 6a 1e 80 00       	push   $0x801e6a
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 87 1e 80 00       	push   $0x801e87
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 6a 1e 80 00       	push   $0x801e6a
  800219:	6a 23                	push   $0x23
  80021b:	68 87 1e 80 00       	push   $0x801e87
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 6a 1e 80 00       	push   $0x801e6a
  80025b:	6a 23                	push   $0x23
  80025d:	68 87 1e 80 00       	push   $0x801e87
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 6a 1e 80 00       	push   $0x801e6a
  80029d:	6a 23                	push   $0x23
  80029f:	68 87 1e 80 00       	push   $0x801e87
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 6a 1e 80 00       	push   $0x801e6a
  8002df:	6a 23                	push   $0x23
  8002e1:	68 87 1e 80 00       	push   $0x801e87
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 6a 1e 80 00       	push   $0x801e6a
  800343:	6a 23                	push   $0x23
  800345:	68 87 1e 80 00       	push   $0x801e87
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80042c:	ba 14 1f 80 00       	mov    $0x801f14,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800457:	51                   	push   %ecx
  800458:	50                   	push   %eax
  800459:	68 98 1e 80 00       	push   $0x801e98
...
read(int fdnum, void *buf, size_t n)
{
  ...
  800681:	53                   	push   %ebx
  800682:	50                   	push   %eax
  800683:	68 d9 1e 80 00       	push   $0x801ed9
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800756:	53                   	push   %ebx
  800757:	50                   	push   %eax
  800758:	68 f5 1e 80 00       	push   $0x801ef5
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80080b:	53                   	push   %ebx
  80080c:	50                   	push   %eax
  80080d:	68 b8 1e 80 00       	push   $0x801eb8
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a6e:	68 24 1f 80 00       	push   $0x801f24
  800a73:	68 2b 1f 80 00       	push   $0x801f2b
  800a78:	68 82 00 00 00       	push   $0x82
  800a7d:	68 40 1f 80 00       	push   $0x801f40
  800a82:	e8 c0 05 00 00       	call   801047 <_panic>
	assert(r <= PGSIZE);
  800a87:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a8c:	7e 19                	jle    800aa7 <devfile_read+0x6b>
  800a8e:	68 4b 1f 80 00       	push   $0x801f4b
  800a93:	68 2b 1f 80 00       	push   $0x801f2b
  800a98:	68 83 00 00 00       	push   $0x83
  800a9d:	68 40 1f 80 00       	push   $0x801f40
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b80:	68 57 1f 80 00       	push   $0x801f57
  800b85:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800c30:	50                   	push   %eax
  800c31:	56                   	push   %esi
  800c32:	68 5e 1f 80 00       	push   $0x801f5e
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ed4:	68 76 1f 80 00       	push   $0x801f76
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801063:	56                   	push   %esi
  801064:	50                   	push   %eax
  801065:	68 84 1f 80 00       	push   $0x801f84
  ...
  801076:	e8 54 00 00 00       	call   8010cf <vcprintf>
	cprintf("\n");
  80107b:	c7 04 24 6f 1f 80 00 	movl   $0x801f6f,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8011ce:	0f be 80 a7 1f 80 00 	movsbl 0x801fa7(%eax),%eax
  8011d5:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801362:	50                   	push   %eax
  801363:	68 bf 1f 80 00       	push   $0x801fbf
  801368:	53                   	push   %ebx
  801369:	56                   	push   %esi
  ...
  80137d:	52                   	push   %edx
  80137e:	68 3d 1f 80 00       	push   $0x801f3d
  801383:	53                   	push   %ebx
  801384:	56                   	push   %esi
  ...
  8013a8:	b8 b8 1f 80 00       	mov    $0x801fb8,%eax
