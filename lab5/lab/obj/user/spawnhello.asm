...
umain(int argc, char **argv)
{
  ...
  800067:	50                   	push   %eax
  800068:	68 84 24 80 00       	push   $0x802484
  80006d:	6a 09                	push   $0x9
  80006f:	68 9c 24 80 00       	push   $0x80249c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000f7:	56                   	push   %esi
  8000f8:	50                   	push   %eax
  8000f9:	68 b8 24 80 00       	push   $0x8024b8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800262:	0f be 80 db 24 80 00 	movsbl 0x8024db(%eax),%eax
  800269:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003f6:	50                   	push   %eax
  8003f7:	68 f3 24 80 00       	push   $0x8024f3
  8003fc:	53                   	push   %ebx
  8003fd:	56                   	push   %esi
  ...
  80043c:	b8 ec 24 80 00       	mov    $0x8024ec,%eax
